...
public class UserProfileConfiguration {
	...
	public DataSource dataSource() {
		...
		//Sanity check for User profile
		
		List<Map<String, Object>> name = jdbcTemplate.queryForList("SELECT NAME FROM T_USER_PROFILE");
		logger.info("System has " + name.size() + " employees");
