...
import io.pivotal.microservices.users.UserProfileConfiguration;
...
@Import(UserProfileConfiguration.class)
...
//	protected AccountRepository accountRepository;
	...
	public static void main(String[] args) {
		...
		// accounts-server.yml
		System.setProperty("spring.config.name", "userprofile-server");
